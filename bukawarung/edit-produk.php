...
<body>
        ...
        <div class="container">
            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- <input name="deskrepsi" class="input-control" placeholder="Deskrepsi"> -->
                    <!-- <textarea class="input-contror" name="deskrepsi" placeholder="deskrepsi"> value="<?php echo $p->product_description ?>" </textarea> -->
    ...
    <center>
        <h2 style="color: #54B435;">Maaf Masih Banyak <b>BUG'nya</b></h2>
    </center>
